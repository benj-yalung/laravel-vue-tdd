...
export const AlertQuestion = (title = 'Question', text = 'Question description', showCancelButton = true, confirmButtonText = 'Yes, Delete!') => {
...
/**
 * Toast message for info exception
 * 
 * @param {String} title 
 * @param {String} text 
 */
 export const ToastInfo = (title = '', text = 'Something went wrong!') => {
    Toast.fire({
        icon: 'info',
        title: title,
        text: text
